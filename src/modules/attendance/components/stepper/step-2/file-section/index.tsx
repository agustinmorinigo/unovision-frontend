...
export default function FileSection() {
  ...
  // ACÁ O EN EL ON ADD FILE HAY ALGO MAL. SI SETEO TODO, RECARGO LA PÁGINA, CAMBIO DE MES MALO Y LUEGO MES BUENO, ME DA ERROR. NO SE ESTÁ PERSISITIENDO O GUARDANDO CORRECTAMENTE EL FILE DATE VALIDATION EN EL STORE.
  useEffect(() => {
  ...
  return (
    <Card className="w-full flex flex-col gap-4">
      <div className='w-full flex flex-col gap-1'>
        ...
        <p className='text-sm text-muted-foreground'>Selecciona el archivo que corresponde al reporte de asistencia que deseas generar.</p>
      </div>
      ...
      >
        ...
        <AlertDescription>
          El archivo que has subido no cumple con los requisitos necesarios. Por favor, revisa los requisitos de arriba y vuelve a intentarlo.
        </AlertDescription>
      </Alert>
