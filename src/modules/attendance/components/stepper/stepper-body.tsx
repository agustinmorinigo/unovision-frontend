...
const steps: Record<number, ComponentType> = {
  1: Step1,
  2: Step2,
  // TO DO: FALTA VALIDAR QUE EL USUARIO EXISTA EN EL SISTEMA, CON ESE TIPO Y VALOR DE DOCUMENTO. VER SI LO HAGO ACÁ O EN OTRO LADO... EMPUJAR TODO LO DE ABAJO, A UN STEP MÁS.
  3: Step3,
  4: Step4,
  5: Step5,
  6: Step6,
