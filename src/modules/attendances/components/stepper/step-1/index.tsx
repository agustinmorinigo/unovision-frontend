...
import MetricItem from '@/modules/attendances/components/stepper/step-1/metric-item'
import RequirementItem from '@/modules/attendances/components/stepper/step-1/requirement-item'
        ...
        <CardContent className="w-full flex flex-col gap-4">
          {
            steps.map(({ step, title, description }) => (
              <div className="w-full flex items-start gap-4 p-4 rounded-lg bg-muted-foreground/6">
